...
const CACHE_NAME = 'property-management-v2.23.0';
const urlsToCache = [
  '/',
  '/index.html',
  '/login.html',
...
async function doBackgroundSync() {
  ...
  try {
    // You could store offline actions in IndexedDB and sync them here
...
// Share target handler (for future features)
self.addEventListener('fetch', event => {
...
async function handleShareTarget(request) {
  // Handle shared content (like photos for property listings)
  console.log('Service Worker: Share target handled');
